...
datas = [('chroma_db', 'chroma_db'), ('.env', '.')]
binaries = []
hiddenimports = ['rfc3987', 'rfc3987_syntax', 'jsonschema', 'chromadb', 'langchain', 'langchain_community', 'langchain_openai', 'langchain_chroma', 'huggingface_hub', 'sentence_transformers']
